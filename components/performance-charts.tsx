...
export function PerformanceCharts() {
  const handleExportPDF = () => {
    ...
    doc.setFontSize(14)
    doc.text("Grade Distribution", 20, doc.lastAutoTable.finalY + 20)
    ...
    doc.setFontSize(14)
    doc.text("Progress Over Time", 20, doc.lastAutoTable.finalY + 20)
    ...
    doc.setFontSize(14)
    doc.text("Performance Metrics Summary", 20, doc.lastAutoTable.finalY + 20)
