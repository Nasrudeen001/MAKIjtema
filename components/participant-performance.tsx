...
export function ParticipantPerformance() {
  const handleExportReport = () => {
    ...
    logoImg.onload = () => {
      ...
      doc.setFontSize(10)
      doc.text(`Active Participants: ${activeParticipants}`, 20, doc.lastAutoTable.finalY + 30)
      doc.text(`Average Performance: ${averagePerformance.toFixed(1)}%`, 20, doc.lastAutoTable.finalY + 35)
      doc.text(`Total Certificates: ${totalCertificates}`, 20, doc.lastAutoTable.finalY + 40)
